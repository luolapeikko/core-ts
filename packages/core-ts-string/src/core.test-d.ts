import type {EmptyString, NumberString, PrefixedString, SuffixedString} from '@luolapeikko/core-ts-type';
import {assertType, describe, it} from 'vitest';
import {StringCore as S} from './core';

describe('Test StringCore functions', () => {
	describe('Type tests', () => {
		it('it should assert valid types', () => {
		...
		it('should give error for invalid types', () => {

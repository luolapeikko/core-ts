...
export class ArrayCore {
	 ...
	 * @since v0.0.1
	 */
	public static is<T = unknown>(value: T): value is IsGuard<T, readonly unknown[]> {
	 ...
	 * @since v0.0.1
	 */
	public static isNot<T = unknown>(value: unknown): value is IsNotGuard<unknown, readonly T[]> {
	 ...
	 * @since v0.0.1
	 */
	public static notOneOf<T>(arr: readonly T[], value: T): boolean {
	 ...
	 * @template T The type of elements contained in the array.
	 * @param {readonly T[]} arr - The array to check.
	 * @param {readonly T[]} values - The values to test for membership in `arr`.
	 ...
	 * @since v0.0.1
	 */
	public static anyOf<T>(arr: readonly T[], values: readonly T[]): boolean {
	 ...
	 * @template T The type of elements contained in the array.
	 * @param {readonly T[]} arr - The array to check.
	 * @param {readonly T[]} values - The values to verify are not in `arr`.
	 ...
	 * @since v0.0.1
	 */
	public static notAnyOf<T>(arr: readonly T[], values: readonly T[]): boolean {
	 ...
	 * @template T The type of elements contained in the array.
	 * @param {readonly T[]} arr - The array whose elements are checked.
	 * @param {readonly T[]} values - The superset against which to check membership.
	 ...
	 * @since v0.0.1
	 */
	public static allOf<T>(arr: readonly T[], values: readonly T[]): boolean {
